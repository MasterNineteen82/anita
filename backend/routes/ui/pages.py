...
async def biometric_fusion(request: Request):
    ...
    return templates.TemplateResponse(request, "biometric_fusion.html", {"request": request})
...
async def palm_recognition(request: Request):
    ...
    return templates.TemplateResponse(request, "palm_recognition.html", {"request": request})
...
async def biometric_manager(request: Request):
    ...
    return templates.TemplateResponse(request, "biometric_manager.html", {"request": request})
